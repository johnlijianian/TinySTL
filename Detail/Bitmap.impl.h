...
#ifndef TINYSTL_BITMAP_IMPL_H
#define TINYSTL_BITMAP_IMPL_H
...
namespace TinySTL{
    ...
    template<size_t N>
    void bitmap<N>::setNthInInt8(uint8_t& i, size_t nth, bool newVal){//nth´Ó0¿ªÊ¼
