//
// Created by LJN on 2022/2/28.
//

#ifndef TINYSTL_UNORDERED_SET_IMPL_H
#define TINYSTL_UNORDERED_SET_IMPL_H
...
namespace TinySTL{
    namespace Detail{
        ...
        ust_iterator<Key, ListIterator, Hash, KeyEqual, Allocator>::operator ++(){
            ++iterator_;
            //���ǰ��һλ�󵽴���list��ĩβ������Ҫ��ת����һ����item��bucket��list
                ...
                for (;;){
                    if (bucket_index_ == container_->buckets_.size() - 1){
                        *this = container_->end();
                        ...
                        ++bucket_index_;
                        if (!(container_->buckets_[bucket_index_].empty())){//��list��Ϊ��
...
#endif //TINYSTL_UNORDERED_SET_IMPL_H
